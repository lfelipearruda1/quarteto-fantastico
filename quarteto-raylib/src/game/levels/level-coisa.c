...
static void InitLevel1(Level *level) {
    ...
    data->playerTexture = LoadTexture("assets/coisa-correto.png");
    data->platformTexture = LoadTexture("assets/plataforma-coisa.png");
    data->obstacleTexture = LoadTexture("assets/obstaculo-coisa.png");
